...
/**
 * Represents the JavaScript callback `(factor: optional) => void`.
...
fun interface Func_void_std__optional_double_: (Double?) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(factor: Double?): Unit
}
...
class Func_void_std__optional_double__cxx: Func_void_std__optional_double_ {
  ...
  @FastNative
  private external fun invoke_cxx(factor: Double?): Unit
}
