...
/**
 * Wraps a Swift `(_ factor: Double?) -> Void` as a class.
...
public final class Func_void_std__optional_double_ {
  ...
  private let closure: (_ factor: Double?) -> Void

  public init(_ closure: @escaping (_ factor: Double?) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(factor: bridge.std__optional_double_) -> Void {
    self.closure(factor.value)
  }
